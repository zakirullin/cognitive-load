...
The tricky part is that the previous author may not have experienced a high cognitive load due to the familiarity of the project. It is also possible that he added complexity incrementally, so that the cognitive load was low, and the author could easily fit it all in the head.
