...
---
By [Artem Zakirullin](https://twitter.com/zakirullin) · [LinkedIn](https://www.linkedin.com/in/zakirullin/) · [Support my writing 💚](https://github.com/sponsors/zakirullin)
...
**[John Ousterhout](https://en.wikipedia.org/wiki/John_Ousterhout)** *(Raft, Tcl/Tk)*  
This is an interesting article. When working on a large system, the primary limit to development speed isn't how many lines of code you have to write; it's how much information you have to collect in your mind before you know what those lines are.
