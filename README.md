...
The tricky part is that the previous author may not have experienced a high cognitive load due to the familiarity of the project. It is also possible that he added complexity incrementally, so that the cognitive load was low for him, and he could keep it all in his head.
