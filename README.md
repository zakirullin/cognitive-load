...
## Introduction
There are so many buzzwords and best practices out there, but most of them have failed. These imagined rules aren't grounded in reality - they are based on aesthetics or on a few people’s subjective opinion. We need something more fundamental, something that can't be wrong.   
