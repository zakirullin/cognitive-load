...
> What are those unique mental models? It's some set of rules, usually a mixture of DDD/CQRS/Clean Architecture/Event Driven Architecture. This is an author's own interpretation of the things that excite him the most. His own unique and subjective mental model. Extraneous cognitive load that others have to internalize.
