...
This paper discusses a fundamental thinking tool that would enable us to create simple yet maintainable applications. We would learn to avoid unnecessary cognitive load.
