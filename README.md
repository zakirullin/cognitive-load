...
<details>
  ...
  Like, can you imagine, token `||` has different meaning in <code>requires (!(P&lt;T&gt; || Q&lt;T&gt;))</code> and in <code>requires ((!P&lt;T&gt; || !Q&lt;T&gt;))</code>. The first is the constraint disjunction, the second is good-old logical OR operator, and they behave differently..<br><br>
