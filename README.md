...
Confusion costs time and money. Confusion is caused by high *cognitive load*. It's not some fancy abstract concept, but rather a fundamental human constraint. It provides more concrete insights than the all-too-familiar "keep it simple" approach.
